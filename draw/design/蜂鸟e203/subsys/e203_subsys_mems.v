...
module e203_subsys_mems(
  ...
  //conv channel,changed by longyong
  ...
  wire [4 -1:0]            conv_icb_cmd_wmask;
  
  wire                     conv_icb_rsp_valid;
  wire                     conv_icb_rsp_ready;
  wire [32-1:0]            conv_icb_rsp_rdata;
  wire                     conv_icb_rsp_err;

  //SRAM conv channel,changed by longyong
  wire                     convSRAM_icb_cmd_valid;
  wire                     convSRAM_icb_cmd_ready;
  wire [32-1:0]            convSRAM_icb_cmd_addr; 
  wire                     convSRAM_icb_cmd_read; 
  wire [32-1:0]            convSRAM_icb_cmd_wdata;
  wire [4 -1:0]            convSRAM_icb_cmd_wmask;
  
  wire                     convSRAM_icb_rsp_valid;
  wire                     convSRAM_icb_rsp_ready;
  wire [32-1:0]            convSRAM_icb_rsp_rdata;
  wire                     convSRAM_icb_rsp_err;
 ...
 localparam MROM_DP = 1024;
  ...
  //SRAM for convolution,changed by longyong
  //SRAM:oxC000_0000 -- oxCFFF_FFFF
  .O6_BASE_ADDR       (32'hC000_0000),       
  .O6_BASE_REGION_LSB (28),
  
  //convolution channel,changed by longyong
  //conv:0xD000_0000 -- 0xDFFF_FFFF
  .O7_BASE_ADDR       (32'hD000_0000),       
  .O7_BASE_REGION_LSB (28)
  ...
  //SRAM for convolution
    .o6_icb_enable     (1'b1),

    .o6_icb_cmd_valid  (convSRAM_icb_cmd_valid),
    .o6_icb_cmd_ready  (convSRAM_icb_rsp_ready),
    .o6_icb_cmd_addr   (convSRAM_icb_cmd_addr),
    .o6_icb_cmd_read   (convSRAM_icb_cmd_read),
    .o6_icb_cmd_wdata  (convSRAM_icb_cmd_wdata),
    .o6_icb_cmd_wmask  (convSRAM_icb_cmd_wmask),
    .o6_icb_cmd_lock   (),
    .o6_icb_cmd_excl   (),
    .o6_icb_cmd_size   (),
    .o6_icb_cmd_burst  (),
    ...
    .o6_icb_rsp_valid  (convSRAM_icb_rsp_valid),
    .o6_icb_rsp_ready  (convSRAM_icb_rsp_ready),
    .o6_icb_rsp_err    (convSRAM_icb_rsp_err),
    .o6_icb_rsp_excl_ok(1'b0  ),
    .o6_icb_rsp_rdata  (convSRAM_icb_rsp_rdata),

  //convolution calculation module
    .o7_icb_enable     (1'b1),

    .o7_icb_cmd_valid  (conv_icb_cmd_valid),
    .o7_icb_cmd_ready  (conv_icb_cmd_ready),
    .o7_icb_cmd_addr   (conv_icb_cmd_addr),
    .o7_icb_cmd_read   (conv_icb_cmd_read),
    .o7_icb_cmd_wdata  (conv_icb_cmd_wdata),
    .o7_icb_cmd_wmask  (conv_icb_cmd_wmask),
    .o7_icb_cmd_lock   (),
    .o7_icb_cmd_excl   (),
    .o7_icb_cmd_size   (),
    .o7_icb_cmd_burst  (),
    ...
    .o7_icb_rsp_valid  (conv_icb_rsp_valid),
    .o7_icb_rsp_ready  (conv_icb_rsp_ready),
    .o7_icb_rsp_err    (conv_icb_rsp_err),
    .o7_icb_rsp_excl_ok(1'b0  ),
    .o7_icb_rsp_rdata  (conv_icb_rsp_rdata),
...
sirv_convSRAM_slv #(
  ...
  .cmd_valid     (convSRAM_icb_cmd_valid),
  .din           (convSRAM_icb_cmd_wdata),
  .addr          (convSRAM_icb_cmd_addr),
  .re            (convSRAM_icb_cmd_read),
  .wem           (convSRAM_icb_cmd_wmask),
  .cmd_ready     (convSRAM_icb_cmd_ready),

  .rsp_valid     (convSRAM_icb_rsp_valid),
  .rsp_ready     (convSRAM_icb_rsp_ready),
  .rsp_err       (convSRAM_icb_rsp_err),
  
  .dout          (convSRAM_icb_rsp_rdata),
  .clk           (clk  ),
  .rst_n         (rst_n)
);
...
sirv_conv_slv #(
  ...
  .cmd_valid    (conv_icb_cmd_valid),
  .cmd_ready    (conv_icb_cmd_ready),
  .cmd_addr     (conv_icb_cmd_addr),
  .cmd_read     (conv_icb_cmd_read),
  .cmd_wdata    (conv_icb_cmd_wdata),
  .cmd_wmask    (conv_icb_cmd_wmask),

  .rsp_valid    (conv_icb_rsp_valid),
  .rsp_ready    (conv_icb_rsp_ready),
  .rsp_err      (conv_icb_rsp_err),
  .rsp_rdata    (conv_icb_rsp_rdata),
